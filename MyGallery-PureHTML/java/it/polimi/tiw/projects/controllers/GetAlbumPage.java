...
public class GetAlbumPage extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		//controlla se il tasto "next" sia da abilitare o no
		try {
		...
		//controlla se il tasto "previous" sia da abilitare o no
		if (currentPage > 1) {
			hasPrevious = true;
		}
		
		//controlla se l'immagine selezionata è nella pagina corrente
		for(Image i : images) {
