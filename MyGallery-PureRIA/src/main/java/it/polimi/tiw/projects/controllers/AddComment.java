...
public class AddComment extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Integer imageId = Integer.parseInt(StringEscapeUtils.escapeJava(request.getParameter("imageSelectedId")));
		String creatorUsername = user.getUsername();
		String text = StringEscapeUtils.escapeJava(request.getParameter("commentText"));
		...
		//String path = getServletContext().getContextPath() + "/GetAlbumPage?idAlbum=" +album.getId() + "&currentPage=1&imageSelected=-1";
